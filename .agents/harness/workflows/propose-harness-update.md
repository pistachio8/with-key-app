...
proposal: {대상, Level, meta-eval 결과, diff 요약, 승인 필요자, reason-code(weaken 시), risks, validation-plan}.
next-step: approve-and-apply | revise | reject→code-fix task(Case A).
