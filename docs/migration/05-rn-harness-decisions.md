...
3. **[04 §9](./04-rn-architecture.md) PO 결정 1건** — Bottom Tabs 새 IA 승인 + screenshot acceptance. (invite re-tap UX는 2026-06-11 수용 확정 — 마찰은 웹 랜딩 재탭 안내 UX로 완화, [04 A7](./04-rn-architecture.md) 참조)
