...
- Web Push 구독 read(`notification-prefs` 의 `fetchActiveSubscriptionEndpoint`)는 RN 미포팅 — push 모델이 `device_push_tokens` 로 교체(D-2 — [ADR-0041](./0041-rn-push-token-model.md) 확정).
