...
> **2026-05-14 UI 리비전 이후 IA(라우트 폐기·신설 포함) SoT는 [QA_REGRESSION_2026-05-14.md §1 화면 인벤토리](./QA_REGRESSION_2026-05-14.md)** — 아래 표는 v0.x 시점 와이어프레임 기준이며, 본 표 자체는 PR8 cleanup에서 일괄 갱신 예정.
